...
def create_regular_lonlat_grid(
    ...
    def create_tripolar_grid(
        ...
        _create_tripolar_grid = cls.lib.create_tripolar_grid
    ...
    def create_grid_from_file(
        ...
        _create_grid_from_file = cls.lib.create_grid_from_file
    ...
    def create_simple_cartesian_grid(
        ...
        _create_simple_cartesian_grid = cls.lib.create_simple_cartesian_grid
    ...
    def create_spectral_grid(
        ...
        _create_spectral_grid = cls.lib.create_spectral_grid
    ...
    def create_conformal_cubic_grid(
        ...
        _create_conformal_cubic_grid = cls.lib.create_conformal_cubic_grid
    ...
    def create_gnomonic_cubic_grid_GR(
        ...
        _create_gnomonic_cubic_grid_GR = cls.lib.create_gnomonic_cubic_gridGR
    ...
    def create_gnomonic_cubic_grid(
        ...
        _create_gnomonic_cubic_grid = cls.lib.create_gnomonic_cubic_grid
    ...
    def create_f_plane_grid(
        ...
        _create_f_plane_grid = cls.lib.create_f_plane_grid
